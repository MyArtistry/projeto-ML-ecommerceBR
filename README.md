...
# Camada Silver: Criação de Views para responder perguntas sobre a empresa usando tabelas de dados tratadas, mas ainda sem relacionamento direto.

# Relatório da Análise Exploratória de Dados no SQL - Silver  
# Análise Exploratória de Dados (EDA)  

# Objetivo:  
A análise exploratória de dados (EDA) apresenta os resultados das views sobre as perguntas:  
